...
# python part_c_multi_best.py --dataset_root "dataset_for_A2\dataset_for_A2\multi_dataset" --save_weights_path "weights_c"
...
def train(W1,b1,W2,b2,W3,b3,W4,b4,W5,b5, X, Y, epochs, method, batch_size, lr, beta,beta1,beta2,epsilon):
  ...
  for epoch in range(epochs):
    ...
    for X_b,Y_b in zip(X_batch,Y_batch):
      ...
      if method == 'momentum':
        gW1,gb1,gW2,gb2,gW3,gb3,gW4,gb4,gW5,gb5 = momentum(beta,dW1,db1,dW2,db2,dW3,db3,dW4,db4,dW5,db5,gW1,gb1,gW2,gb2,gW3,gb3,gW4,gb4,gW5,gb5)
...
def momentum(beta,dW1,db1,dW2,db2,dW3,db3,dW4,db4,dW5,db5,gW1,gb1,gW2,gb2,gW3,gb3,gW4,gb4,gW5,gb5):
  gW1 = beta * gW1 + (1 - beta) * dW1
  gb1 = beta * gb1 + (1 - beta) * db1
  gW2 = beta * gW2 + (1 - beta) * dW2
  gb2 = beta * gb2 + (1 - beta) * db2
  gW3 = beta * gW3 + (1 - beta) * dW3
  gb3 = beta * gb3 + (1 - beta) * db3
  gW4 = beta * gW4 + (1 - beta) * dW4
  gb4 = beta * gb4 + (1 - beta) * db4
  gW5 = beta * gW5 + (1 - beta) * dW5
  gb5 = beta * gb5 + (1 - beta) * db5
...
print(np.sum(Y==predictions)/len(Y))
